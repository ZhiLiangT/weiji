...
public class SettingsActivity extends Activity {
    ...
    public static final String SENSITIVITY_VALUE = "sensitivity_value";// ����ֵ
    ...
    private void listener() {
        sb_sensitivity
                .setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {    // ����ֵ�����ļ���
    ...
    private void init() {
        ...
        sb_step_length.setProgress((step_length - 40) / 5);               //������ť�ڽ������ռ�ñ���
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.save:
                ...
                Toast.makeText(SettingsActivity.this, "保存记录", Toast.LENGTH_SHORT).show();
